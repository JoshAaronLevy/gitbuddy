...
const commitCommand = async (message) => {
	...
	try {
		...
		// const commitExec = shell.exec(`git commit -m ${commitMessage}`, { async: true, shell: "/bin/bash" });
		// console.log(commitExec);
		shell.exec(`git commit -m ${commitMessage}`, { async: true }, (code, stdout, stderr) => {
		...
		// 	console.log(data);
		// 	if (data.includes(commitMessage)) {
		// 		console.log(true);
		// 		spinner.success({
		// 			text: white(bold("Data found!"))
		// 		});
		// 	} else {
		// 		console.log(false);
		// 		spinner.error({
		// 			text: white(bold("Data not found!"))
		// 		});
		// 	}
		// 	return data;
		// 	// console.log("data:\n", data);
